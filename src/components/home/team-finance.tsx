...
const TeamFinance = () => {
  return (
    <div className='flex flex-col md:flex-row gap-10 md:gap-20 py-20 w-full items-center text-center md:text-left justify-center md:pb-16 '>
      ...
      <div className='flex flex-col gap-20 w-full md:w-1/2 items-center text-center order-1 md:order-2'>
