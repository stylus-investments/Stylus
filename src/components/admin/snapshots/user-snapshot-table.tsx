...
import UserSnapshotBreadCrumb from './user-snapshot-breadcrumb'
...
interface SnapshotTableProps {
    snapshotData: Awaited<ReturnType<(typeof caller['snapshot']['getSnapshotData'])>>
    snapshotID: number
}
...
const UserSnapshotTable: React.FC<SnapshotTableProps> = ({ snapshotData, snapshotID }) => {
    ...
    const { data, refetch } = trpc.snapshot.getSnapshotData.useQuery(Number(snapshotID), {
        initialData: snapshotData,
        refetchOnMount: false,
        refetchOnReconnect: false
    })
    const updateUserSnapshots = trpc.snapshot.updateUserSnapshots.useMutation()
