...
const EnterAmount = (props: {
    ...
    const { setFormData, formData, closeOrder, indexPrice, currency, setCurrency } = props
    ...
    const handleAmountChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        let newPriceInUsd = newAmount * Number(indexPrice);
        ...
        if (newPriceInPhp > 500000) {
            ...
            const cappedAmount = newPriceInUsd / Number(indexPrice);
    ...
    const handlePriceChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const newAmount = newPriceInUsd / Number(indexPrice);
